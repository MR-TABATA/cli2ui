...
urlpatterns = [
    ...
    path("connections/clear", views.clear_connections, name="clear_connections"),
    path("c/<int:pk>/", views.workspace, name="workspace"),
    path("c/<int:pk>/delete", views.delete_connection, name="delete_connection"),
    ...
    path("c/<int:pk>/table/export", views.table_export, name="table_export"),
    path("c/<int:pk>/table/filter", views.table_filter, name="table_filter"),
    path("c/<int:pk>/table/import", views.table_import, name="table_import"),
